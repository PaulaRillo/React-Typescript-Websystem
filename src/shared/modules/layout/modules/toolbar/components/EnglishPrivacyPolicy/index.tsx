export const EnglishPrivacyPolicy = () => {
  return (
    <>
      ...
      <p>
        We use Your Personal data, Company data to provide and improve the
        Service. By using the Service, You agree to the collection and use of
        information in accordance with this Privacy Policy.
      </p>
      <p>
        By navigating the Website, signing up for our services and or products,
        you accept the terms of this Privacy Policy
      </p>
      <p>
        <b>
          If you do not agree with our privacy policy, do not access or use our
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to H&CO, LLP, 2320 Ponce de Leon Blvd Coral
            Gables, FL 33134.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Company Data</strong> is any information that relates to a
            business operations and transactions generated daily which might be
            shared with us or generated from our services.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to H&CO Apps, accessible from
            <a
              href="https://www.hcoapps.com/"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://www.hcoapps.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <h1>Collecting and Using Your Personal data and Company data </h1>
      <h2>Types of Data Collected</h2>
      <h3>Company Data</h3>
      <p>
        While using Our Service, We may ask You to provide Us with certain
        information that can be used to contact or identify You or Your Company.
        Company information may include, but is not limited to:
      </p>
      <ul>
        <li>
      ...
      <p>
        This information might also include any information generated or that
        you provided to our services. Our products allow you to post, create,
        edit, delete many kinds of documents and transactions according to the
        product and product features you are using. We store and collect all
        that information in our databases when you provide it to us. Some
      ...
      <ul>
        ...
        <li>
          <p>Accounting and Financial Information</p>
        </li>
        <li>
          <p>Inventory and Stock information</p>
        </li>
        <li>
          <p>Your customers information</p>
        </li>
        <li>
          <p>Invoices</p>
        </li>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            calls, SMS, or other equivalent forms of electronic communication,To
            contact You by email, telephone such as a mobile application's push
      ...
      <p>
        Your information is stored in one or more databases and object storages
        in infrastructure in the United States of America.
      </p>
      ...
      <p>
        If a minor has provided information or registered in our services,
        please contact us to request removal of the information.
      </p>
      ...
      <p>
        ...
        Policy and agree to its Terms and Conditions, allows us to collect and
      ...
      <ul>
        <li>By email: privacy@hcoapps.com</li>
      </ul>
    </>
  );
};
